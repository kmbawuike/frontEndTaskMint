  ...
  return (
    <Fragment>
      ...
      <section className="chart-container">
        <section className="chart-graph-container">
          <div className="date-container">
            <p class="date">Today: 5, Aug 2018</p>
            <div className="icon-left">
              <span className="date-span">
                <p className="date-span__p">1 Jan - 1 Jun</p>{" "}
                <FaAngleDown className="date-span__icon" />
              </span>
              <div className="icon-container">
                <span className="icon-span">
                  <FaAngleLeft className="icon-span-icon" />
                </span>
                <span className="icon-span">
                  <FaAngleRight className="icon-span-icon" />
                </span>
              </div>
            </div>
          </div>
          ...
          <div className="container">
            ...
            <div className="chart">Feb</div>
            <div className="chart">Mar</div>
            <div className="chart">April</div>
            <div className="chart">May</div>
            <div className="chart June">Jun</div>
          </div>

          <div className="svg-container-background">
            <svg width="660" height="160" viewBox="0 0 689 160" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <section className="chart-range-container">
          <ChartRange order1="Pending Orders"
          order2="Reconcilled Orders" type="Orders" />

          <ChartRange type="Payments"
           order1="Un-reconcilled Payments"
           order2="Reconcilled Payments"/>
        </section>
      </section>
    </Fragment>
  )
